...
program eos_table_maker
  ...
  initial_eos_table_name = "./original_tables/bhb_l_frdm_sc_v1.02.bin"
  Hempel = .true.
  lump_into_np = .false.
  ...
  nt_rho = 301 !number of density entries in initial table
  ...
  logrhomax = 15.220249d0 !global maximum of final table
