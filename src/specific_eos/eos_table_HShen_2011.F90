...
program eos_table_maker
  ...
  initial_eos_table_name = "./original_tables/eos2.tab"

  nt_temp = 91 !number of temperature entries in initial table                                                               
  nt_yp = 65 !number of yp entries in initial table                                                                          
  nt_rho = 110 !number of density entries in initial table                                                                    
  nvars = 13 !columns in the initial table - 3 (don't care about ye
             !and rho etc., know those)

  !size you want to final table in
  !denstiy
  nlogrho = 220 !number of density bins
  logrhomin = 3.0d0 !global minimum of final table
  logrhomax = 16.0d0 !global maximum of final table
  ...
  ienergy  = 2 !specific internal energy code assumes units of MeV/baryon
  ientropy = 3 !in units of /k_B
  iabar    = 4 !mass number of heavies, average
  izbar    = 5 !atomic number of heavies, average
  imasseff = 6 !we don't use this
  ixn      = 7 !mass fraction of neutrons
  ixp      = 8 !mass fraction of protons
  ixa      = 9 !mass fraction of alphas
  ixh      = 10 !mass fraction of heavies
  ipress   = 11 !press assume units of MeV/fm^3
  ...
  !neutron and proton
  imun     = 12 !chemical potential of neutron, MeV
  imup     = 13 !chemical potential of proton, MeV
  imue     = 14 !chemical potential of electron, MeV, includes rest
