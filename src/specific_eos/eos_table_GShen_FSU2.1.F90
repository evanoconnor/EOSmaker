...
program eos_table_maker
  ...
  initial_eos_table_name = "./original_tables/FSU2.1eosb1.04.dat"
  ...
  nvars = 14 !columns in the initial table - 3 (don't care about ye
  ...
  ienergy  = 14 !specific internal energy code assumes units of
